...
const EventSection = ({ props, regEvents, setRegEvents }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 py-5 lg:mt-0 lg:py-0 w-full lg:w-[300px] border-b-2 lg:border-b-0 lg:border-l-2 border-zinc-900/[0.1] lg:px-5 flex flex-col items-start relative">
