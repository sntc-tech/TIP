...
const ContactsHeader = () => {
  return (
    <div className="w-screen h-[60vh] bg-[url(/images/contact.png)] bg-center bg-cover flex flex-col px-12 py-12 justify-end items-center md:items-start text-zinc-100">
